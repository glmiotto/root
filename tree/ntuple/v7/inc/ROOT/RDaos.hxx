...
public:
   ...
   struct FetchUpdateArgs {
      ...
      FetchUpdateArgs(DistributionKey_t &d, std::vector<AttributeKey_t>&& as, std::vector<d_iov_t> &&vs, bool is_async);
...
public:
   ...
   struct RWOperation {
      RWOperation() = default;
      RWOperation(daos_obj_id_t o, DistributionKey_t d,
                  std::vector<AttributeKey_t> &&as, std::vector<d_iov_t> &&vs)
      ...
      int insert(daos_obj_id_t o, DistributionKey_t d, AttributeKey_t a, d_iov_t &v) {
         fOid = o;
         fDistributionKey = d;
         fAttributeKeys.emplace_back(a);
         fIovs.emplace_back(v);
         return 0;
      }
      int insert(AttributeKey_t a, d_iov_t &v) {
         fAttributeKeys.emplace_back(a);
         fIovs.emplace_back(v);
         return 0;
      }
